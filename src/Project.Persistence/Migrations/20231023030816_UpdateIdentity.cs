    ...
    public partial class UpdateIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Approvers_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagCards", x => new { x.CardId, x.TagId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    TagCardCardId = table.Column<int>(type: "int", nullable: true),
                    TagCardTagId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tags_TagCards_TagCardCardId_TagCardTagId",
                        columns: x => new { x.TagCardCardId, x.TagCardTagId },
                        principalTable: "TagCards",
                        principalColumns: new[] { "CardId", "TagId" });
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_TagCardCardId_TagCardTagId",
                table: "Tags",
                columns: new[] { "TagCardCardId", "TagCardTagId" });
